...
| [xsd/adm.xsd](./xsd/caselaw-decision.xsd)                                                    | `http://docs.oasis-open.org/legaldocml/ns/akn/3.0`  | Schema for verwaltungsvorschriften. (You should validate against this one)        |
| [xsd/adm-metadata.xsd](./xsd/caselaw-decision-metadata.xsd)                                  | `http://rechtsinformationen.bund.de/schema/ris/0.1` | Restrictions for the ris namespace that only apply to verwaltungsvorschriften     |

...
| -------------------------------------------------------------------------------------------- | ---------------------------------------------------- | --------------------------------------------------------------------------------- |
| [xsd/ris](./xsd/ris)                                                                         | `http://rechtsinformationen.bund.de/schema/ris/0.1`  | Schema files for all elements and types in the ris namespace                      |
| [xsd/adm.xsd](./xsd/adm.xsd)                                                                 | `http://docs.oasis-open.org/legaldocml/ns/akn/3.0`   | Schema for verwaltungsvorschriften. (You should validate against this one)        |
| [xsd/adm-metadata.xsd](./xsd/adm-metadata.xsd)                                               | `http://rechtsinformationen.bund.de/schema/ris/0.1`  | Restrictions for the ris namespace that only apply to verwaltungsvorschriften     |
...
| [xsd/caselaw-decision-metadata.xsd](./xsd/caselaw-decision-metadata.xsd)                     | `http://rechtsinformationen.bund.de/schema/ris/0.1`  | Restrictions for the ris namespace that only apply to caselaw decisions           |
...
| [xsd/caselaw-pending-proceeding-metadata.xsd](./xsd/caselaw-pending-proceeding-metadata.xsd) | `http://rechtsinformationen.bund.de/schema/ris/0.1`  | Restrictions for the ris namespace that only apply to caselaw pending-proceedings |
...
| [xsd/literature-uli-metadata.xsd](./xsd/literature-uli-metadata.xsd)                         | `http://rechtsinformationen.bund.de/schema/ris/0.1`  | Restrictions for the ris namespace that only apply to ULIs                        |
| [xsd/norm-*.xsd](./xsd/)                                                                     | `http://rechtsinformationen.bund.de/schema/norm/0.1` | Schemas for norms (see documentation in [German](./xsd/README-de.md#normen))      |

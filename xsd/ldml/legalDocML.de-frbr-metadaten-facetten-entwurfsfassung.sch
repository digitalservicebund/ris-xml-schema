...
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (. = ('recht.bund.de/institution/bundesregierung', 'recht.bund.de/institution/bundestag', 'recht.bund.de/institution/bundesrat', 'recht.bund.de/institution/bundeskanzler', 'recht.bund.de/institution/bundespraesident')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (. = ('version')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
    />" an dieser Stelle nicht
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (matches(., '^https://www.egesetzgebung.bund.de/eli/dl/\d{4}/[a-zäöüß-]+/[0-9]+/[a-zäöüß-]+/[a-zäöüß-]+/\d{4}-\d{2}-\d{2}/[0-9]+/[a-z]{3}/[a-zöäüß\-]+-\d+$')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
    />" an dieser Stelle nicht
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (matches(., '^https://[a-z]+(\.[a-z]+)+/eli/dl/\d{4}/[a-zäöüß-]+/[0-9]+/[a-zäöüß-]+/[a-zäöüß-]+/\d{4}-\d{2}-\d{2}/[0-9]+/[a-z]{3}$')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
    />" an dieser Stelle nicht
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (matches(., '^https://[a-z]+(\.[a-z]+)+/eli/dl/\d{4}/[a-zäöüß-]+/[0-9]+/[a-zäöüß-]+/[a-zäöüß-]+/\d{4}-\d{2}-\d{2}/[0-9]+/[a-z]{3}/[a-zöäüß\-]+-\d+\.[a-zöäüß]+$')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
    />" an dieser Stelle nicht
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (. = ('regelungsentwurf', 'sonstiges-dokument')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
    />" an dieser Stelle nicht
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (matches(., '^[0-9]+$')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
    />" an dieser Stelle nicht
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (matches(., '^https://www.egesetzgebung.bund.de/eli/dl/\d{4}/[a-zäöüß-]+/[0-9]+/[a-zäöüß-]+/[a-zäöüß\-]+-\d+$')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
    />" an dieser Stelle nicht
  ...
  >
    <sch:assert
      ...
      test="if ($ist-entwurfsfassung) then (matches(., '^https://www.egesetzgebung.bund.de/eli/dl/\d{4}/[a-zäöüß-]+/[0-9]+/[a-zäöüß-]+$')) else true()"
    >In der Entwurfsfassung ist das Literal "<sch:value-of
      select="."
    />" an dieser Stelle nicht
